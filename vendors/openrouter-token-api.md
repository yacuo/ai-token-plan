...
> 可视化页面：[https://tokenplan.pw/openrouter-token-api/](https://tokenplan.pw/openrouter-token-api/)
...
- 计费方式：按量计费
- 价格单位：通常按每百万 tokens 计费
- 免费模型：部分模型提供免费或低成本入口

## 主要模型

- OpenAI 系列
- Claude 系列（OpenRouter 参考 $1/$5/百万 tokens 起）
- Gemini 系列（OpenRouter 参考 $0.15/$0.60/百万 tokens 起）
- DeepSeek / Qwen / xAI 等多家模型（OpenRouter 参考 $0.15/$0.60/百万 tokens 起）
- OpenRouter Router 系列
...
- [OpenRouter API 价格详情](https://tokenplan.vip/openrouter-token-api)
