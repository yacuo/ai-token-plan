...
| 平台 | 类型 | 入门价格 | 主要模型 | 关注点 |
|---|---|---:|---|---|
| [Claude](vendors/claude.md) | 订阅 / API | $20/月 | Claude Opus / Sonnet / Haiku | 官方订阅、Claude Code、API |
| [OpenRouter](vendors/openrouter.md) | API 聚合 | 按量计费 | 340+ 模型 | OpenAI 兼容、多模型统一入口 |
| [DeepSeek](vendors/deepseek.md) | API | 按量计费 | DeepSeek V3 / R1 | 国产 API、低成本模型调用 |
| [Kimi](vendors/kimi.md) | Token Plan / API | ¥49/月 | Kimi K2.7 Code / K2.6 | 会员套餐、Agent、编程 |
| [Qwen](vendors/qwen.md) | API | 按量计费 | Qwen 系列 | 通义千问模型生态 |
| [MiniMax](vendors/minimax.md) | Token Plan / API | ¥49/月 | MiniMax-M3 / M2.7 | 积分制、多模态、Agent |
...
- [LLM API 价格目录](guides/api-pricing.md)：整理 OpenAI API 价格、Claude API 价格、Gemini API 价格、DeepSeek API 价格、Qwen API 价格、Doubao API 价格、GLM API 价格等常见大模型 API 价格方向。
